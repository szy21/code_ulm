...
namelist /radiation_driver_nml/ do_radiation, &
                                ...
                                solar_forcing_mag1, solar_forcing_mag2, &
                                solar_forcing_center_lat1, solar_forcing_width_lat1, &
                                solar_forcing_center_lat2, solar_forcing_width_lat2, &
                                solar_forcing_center_lon1, solar_forcing_width_lon1, &
                                solar_forcing_center_lon2, solar_forcing_width_lon2, &
                                solar_forcing_sf1, solar_forcing_sf2
!---------------------------------------------------------------------
!---- private data ----
!-- for netcdf restart
...
!   local variables:
      ...
      real, dimension(ie-is+1,je-js+1)    :: solar_forcing1, solar_forcing2, scaled_solar_forcing
      real  :: c_solar_forcing_lat1, c_solar_forcing_lat2, c_solar_forcing_lon1, c_solar_forcing_lon2, &
               solar_forcing_center_lat1_rad, solar_forcing_center_lat2_rad, solar_forcing_center_lon1_rad, solar_forcing_center_lon2_rad
...
!     print *, 'before _calc    ', mpp_pe()
      ...
      if (add_solar_forcing) then
         solar_forcing_center_lat1_rad = solar_forcing_center_lat1 * PI / 180.0
         solar_forcing_center_lat2_rad = solar_forcing_center_lat2 * PI / 180.0
         solar_forcing_center_lon1_rad = solar_forcing_center_lon1 * PI / 180.0
         solar_forcing_center_lon2_rad = solar_forcing_center_lon2 * PI / 180.0
         c_solar_forcing_lat1 = solar_forcing_width_lat1 * PI / (2.0 * 180.0 * sqrt(2.0 * log(100.0)))
         c_solar_forcing_lat2 = solar_forcing_width_lat2 * PI / (2.0 * 180.0 * sqrt(2.0 * log(100.0)))
         c_solar_forcing_lon1 = solar_forcing_width_lon1 * PI / (2.0 * 180.0 * sqrt(2.0 * log(100.0)))
         c_solar_forcing_lon2 = solar_forcing_width_lon2 * PI / (2.0 * 180.0 * sqrt(2.0 * log(100.0)))
         solar_forcing1(:,:) =  exp(-(lat(:,:) - solar_forcing_center_lat1_rad)**2 / (2.0 * (c_solar_forcing_lat1**2))) * &
                               exp(-(lon(:,:) - solar_forcing_center_lon1_rad)**2 / (2.0 * (c_solar_forcing_lon1**2))) 
      ...
      if (do_rad) then
        call radiation_calc (is, ie, js, je, Rad_time, Time_next, lat, &
                             ...
                             scaled_solar_forcing) ! 070616[ZS]
      endif
