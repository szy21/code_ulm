...
real        :: solar_forcing_center_lat = 0.0
real        :: solar_forcing_center_lon = 0.0
real        :: solar_forcing_width_lat = 0.0
real        :: solar_forcing_width_lon = 0.0
...
namelist /radiation_driver_nml/ do_radiation, &
                                ...
                                solar_forcing_mag, solar_forcing_center_lat, solar_forcing_width_lat, &
                                solar_forcing_center_lon, solar_forcing_width_lon, solar_forcing_sf
!---------------------------------------------------------------------
!---- private data ----
!-- for netcdf restart
...
!   local variables:
      ...
      real  :: c_solar_forcing_lat, c_solar_forcing_lon, solar_forcing_center_lat_rad, solar_forcing_center_lon_rad
...
!     print *, 'before _calc    ', mpp_pe()
      ...
      if (add_solar_forcing) then
         solar_forcing_center_lat_rad = solar_forcing_center_lat * PI / 180.0
         solar_forcing_center_lon_rad = solar_forcing_center_lon * PI / 180.0
         c_solar_forcing_lat = solar_forcing_width_lat * PI / (2.0 * 180.0 * sqrt(2.0 * log(100.0)))
         c_solar_forcing_lon = solar_forcing_width_lon * PI / (2.0 * 180.0 * sqrt(2.0 * log(100.0)))
         solar_forcing(:,:) =  exp(-(lat(:,:) - solar_forcing_center_lat_rad)**2 / (2.0 * (c_solar_forcing_lat**2))) * &
                               exp(-(lon(:,:) - solar_forcing_center_lon_rad)**2 / (2.0 * (c_solar_forcing_lon**2))) 
