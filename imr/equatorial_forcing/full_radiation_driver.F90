...
namelist /full_radiation_driver_nml/ do_conserve_energy, rch4, rn2o, rco2, rf11, rf12, rf113, rf22, &
              ...
              renormalize_sw_fluxes, do_clear_sky_pass, solar_constant, ozone_option, albedo_sw, skc_equator_mag
...
real :: c, mid,  m0 ! 01-25-2016 [SKC]: Add variables to compute skc_forcing
...
! 02-26-2016 [SKC]: Compute shortwave forcing
m0 = 0.10771466123252194
mid = 0.0
c = 30.0 * 3.1415927 / (2.0 * 180.0 * sqrt(2.0 * log(100.0)))
skc_forcing(:,:) = 3.1415927 * ((-1.0 * (skc_equator_mag / m0) * exp(-(rad_lat(:,:) - mid)**2 / (2.0 * (c**2))))) / (cos(rad_lat(:,:)))
!
