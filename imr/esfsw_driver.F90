...
subroutine swresf (press, pflux, temp, rh2o, deltaz, &
                   ...
                   do_totcld_forcing, flag_stoch, Sw_output, skc_forcing) ! 02-09-2016 [SKC]: Add skc_forcing argument
...
real, dimension(:,:),          intent(in)    :: cosz, fracday, skc_forcing ! 02-09-2016 [SKC]: Add skc_forcing argument
...
!---------------------------------------------------------------------
          solarflux_p(:,:) = fracday(:,:) * (solflxband(nband)/solflxtotal_local) * (ssolar + skc_forcing(:,:)) ! 02-09-2016 [SKC]: Add skc_forcing
