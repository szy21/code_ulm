...
!skc_forcing(:,:) = (-1.0 * (skc_tropics_mag / m0_tropics) * exp(-(rad_lat(:,:) - mid_tropics)**2 / (2.0 * (c_tropics**2)))) - ((skc_extratropics_mag / m0_extratropics) * &
!      exp(-(rad_lat(:,:) - mid_extratropics)**2 / (2.0 * (c_extratropics**2))))
!
skc_forcing(:,:) = -1.0
